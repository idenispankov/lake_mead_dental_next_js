      ...
      <div className={styles.section__container}>
        <div className={styles.heading__container}>
          ...
          <p className={styles.section__text}>
            ...
            create a comfortable, personal environment where we get to know each
            and every patient. Every detail of our dental office is designed for
            you, from our friendly dental team to our many amenities to make you
            feel at home.
          </p>
        </div>
